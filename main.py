...
class votingSolution(VotingMachine):
    def __init__(self):
        print()
        list1 = ['BJP','Shivsena(Shinde)','Shivsena(UBT)','NCP','NOTA']
...
def dashboard(voterId):
    ...
    pollInput = Combobox(root, values=["BJP", "SS (SG)","SS (UBT)","NCP","NOTA"], font=(ARIAL, 13, "normal"), textvariable=poll)
    ...
    districtInput = Combobox(root, values=["Ahmednagar", "Pune","Mumbai","Jalgaon","Beed"], font=(ARIAL, 13, "normal"), textvariable=district)
...
def AdminHome():
    ...
    back_btn.place(x=0, y=0, width=100, height=50)
    label = Label(adminFrame, text="Online \nElectronic\nVoting\nMachine", font=(LUCIDA_CONSOLE, 30, "bold"), bg=HIGHLIGHT_BG, fg="white")
    label.place(x=500, y=0, width=400, height=500)
...
def votingResults():
    ...
    party2=Label(resultFrame,text="SS (SG)",font=(LUCIDA_CONSOLE,15,"normal"),bg="white",fg="grey")
    party2.place(x=150,y=200)
    party3=Label(resultFrame,text="SS (UBT)",font=(LUCIDA_CONSOLE,15,"normal"),bg="white",fg="grey")
    party3.place(x=150,y=250)
    party4=Label(resultFrame,text="NCP",font=(LUCIDA_CONSOLE,15,"normal"),bg="white",fg="grey")
    party4.place(x=150,y=300)
    party4=Label(resultFrame,text="NOTA",font=(LUCIDA_CONSOLE,15,"normal"),bg="white",fg="grey")
    party4.place(x=150,y=350)
...
def open_browser(e):
    webbrowser.open_new("gppune.ac.in")
